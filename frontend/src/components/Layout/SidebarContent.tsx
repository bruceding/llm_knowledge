...
export default function SidebarContent({ onNavigate, hideImport }: SidebarContentProps) {
      ...
      <nav className="flex-1 overflow-y-auto p-2">
        ...
        <div className="mb-4">
          ...
          {expandedSections.navigation && (
            <ul className="mt-1 space-y-1">
              <li>
                <Link to="/" className={navItemClass('/')} onClick={onNavigate}>
              ...
              <li>
                <Link to="/documents?status=later" className={navItemClass('/documents?status=later')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/documents?status=archived" className={navItemClass('/documents?status=archived')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/documents" className={navItemClass('/documents')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/tags" className={navItemClass('/tags')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/chat" className={navItemClass('/chat')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
        ...
        <div className="mb-4">
          ...
          {expandedSections.wiki && (
            <ul className="mt-1 space-y-1">
              <li>
                <Link to="/wiki" className={navItemClass('/wiki')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/wiki/entities" className={navItemClass('/wiki/entities')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/wiki/topics" className={navItemClass('/wiki/topics')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li>
                <Link to="/wiki/sources" className={navItemClass('/wiki/sources')} onClick={onNavigate}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
        ...
        {!hideImport && (
          <div className="mb-4">
            <Link to="/import" className={navItemClass('/import')} onClick={onNavigate}>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        {/* Settings */}
        <div className="mb-4">
          <Link to="/settings" className={navItemClass('/settings')} onClick={onNavigate}>
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
