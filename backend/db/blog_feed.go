...
type BlogFeed struct {
	...
	UserID          uint      `gorm:"uniqueIndex:idx_blog_feeds_user_url;not null;default:1" json:"userId"`
	Name            string    `json:"name"`
	IndexURL        string    `gorm:"uniqueIndex:idx_blog_feeds_user_url" json:"indexUrl"`
